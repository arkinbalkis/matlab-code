function qq=quadrantwieghted(rr, m1, m2)
...
qq(dx)=0.5;
for i=2:dx-1
    wieghtp=0.5*(1-tanh(((1:i-1)-m1)/m2));  %the 200 and 50 are parameters and should be changed according to your application
    wieghtp=wieghtp(end:-1:1);
    wieghtf=0.5*(1-tanh(((1:dx-i)-m1)/m2)); %the 200 and 50 are parameters and should be changed according to your application
